...
(function ($) {
    ...
    var bs = {
        3: {
            ...
            icons: {
                ...
                toggle: 'glyphicon-list-alt icon-list-alt'  //fix toggle
            },
            pullClass: 'pull',
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES.en = {
        formatLoadingMessage: function () {
            return '<div class="loading-container"><img src="/CloudReports/img/ajax-loader.gif" class="loading" style="text-align: center;"><div>';
        },
